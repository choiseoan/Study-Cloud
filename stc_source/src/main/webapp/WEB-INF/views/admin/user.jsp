									...
									<div class="pagination">
										<ul>
											<c:choose>
												...
												<c:otherwise>
													<li><a class="pe-7s-angle-left" href="${pageContext.request.contextPath}/admin/user?selectbox=${nowoption }&page=${pageInfo.currentPage - 1 }"></a></li>
											  	</c:otherwise>
											</c:choose>
											<c:forEach begin="${pageInfo.startPage }" end="${pageInfo.endPage }" var="page">
												<li><a href="<%=request.getContextPath() %>/admin/user?selectbox=${nowoption }&page=${page }">${page }</a></li>
											...
											<c:choose>
												...
												<c:otherwise>
													<li><a class="pe-7s-angle-right" href="${pageContext.request.contextPath}/admin/user?selectbox=${nowoption }&page=${pageInfo.currentPage +1 }"></a></li>
												</c:otherwise> 
											</c:choose>      
										</ul>
									</div>
